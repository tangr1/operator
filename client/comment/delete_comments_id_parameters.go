...
// NewDeleteCommentsIDParams creates a new DeleteCommentsIDParams object
// with the default values initialized.
func NewDeleteCommentsIDParams() *DeleteCommentsIDParams {
	return &DeleteCommentsIDParams{}
}

/*DeleteCommentsIDParams contains all the parameters to send to the API endpoint
for the delete comments ID operation typically these are written to a http.Request
*/
